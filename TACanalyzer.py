...
plt.bar(X_axis - 0.1, y, 0.2, color = 'b', edgecolor = 'black',label = 'Research TA ticket')
plt.bar(X_axis + 0.1, y2, 0.2, color = 'g', edgecolor = 'black', label = 'General TA ticket (Excluding research TA)')
plt.xticks(X_axis, x) 
